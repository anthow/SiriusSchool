...
<h3 className="mb-5   text-3xl font-black  text-siriusblue" >{data.datoCmsFormationTroi.titreFormation} </h3>
<div className="" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.informationsGNRales }}></div>
<div className="md:flex  mt-8 md:space-x-8">
          <div className=" flex space-x-2 ">
            <FontAwesomeIcon className="text-siriusblue" icon={faCalendar} size="1x" /><p className="text-siriusblue text-sm"> {data.datoCmsFormationTroi.durE} </p>
          ...
          <div className=" flex space-x-2">
            ...
            <p className="text-siriusblue text-sm"> Niveau: {data.datoCmsFormationTroi.niveau}</p>
          </div>
        </div>
        <h3 className="mb-5 mt-8  text-siriusblue text-2xl font-black" > Public cible</h3>
    <div className="" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.publicCible }}></div>
...
<article className="border-formationtrois border mb-8 md:mb-0 h-full p-4 rounded">
    <h4 className="mb-10  text-center  text-xl text-formationtrois font-black">La formation</h4>
    <div className="listform pl-4" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.programme }}></div>
</article>
<article className="  bg-siriusblue  p-4 text-white rounded">
    ...
    <div className="listform pl-4" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.softkills }}></div>
</article>

        </section> 
        <section className="w-10/12 m-auto mt-20"> 
<h3 className="mb-5  text-siriusblue text-2xl font-black" > Conditions d'admission</h3>
    <div className="" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.condition }}></div>
