...
<div className="text-white" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.informationsGNRales }}></div>
...
<h3 className="mb-5  text-siriusblue text-2xl font-bold" > Public cible</h3>
    ...
    <article className="border-formationtrois border p-4 rounded">
    <h4 className="mb-10  text-center text-xl text-formationtrois font-bold">la formation</h4>
    <div className="" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.programme }}></div>
</article>
<article className="  bg-siriusblue p-4 text-white rounded">
    ...
    <div className="" dangerouslySetInnerHTML={{ __html: data.datoCmsFormationTroi.softkills }}></div>
</article>
